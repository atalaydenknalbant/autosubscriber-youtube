...
if heroku == "available":
    required_dict = {
        ...
        "username_tolikes": os.environ["tolikes_username"],
        "pw_tolikes": os.environ["tolikes_password"],
...
# config.ini
    ...
    required_dict = {
        ...
        "username_tolikes": userinfo["tolikes_username"],
        "pw_tolikes": userinfo["tolikes_password"],
        "yt_useragent": userinfo["youtube_useragent"]
    }

if __name__ == "__main__":
    sws.tolikes_functions(required_dict)